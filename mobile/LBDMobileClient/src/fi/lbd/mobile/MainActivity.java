...
/**
 * Main activity for the LBDMobileClient
 * 
 * @author tommi
 */
public class MainActivity extends Activity implements ClientController {
	...
	@Override
	public void changeView(ViewType view, Bundle args) {
		switch (view) {
			case Map:
				// TODO: Same instance should be used.
